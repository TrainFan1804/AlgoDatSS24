...
public class Management implements IManagement {
    ...
    private AlgoHashMap employeedData;
    
    public Management() {
		
		this.employeedData = new AlgoHashMap();
	}
	...
	public Management(String filePath) throws IOException {
		...
		this.employeedData = new AlgoHashMap(INITIAL_SIZE);
		// datei lesen
    ...
    public IEmployee search(int key) {
        ...
        return this.employeedData.search(key);
    }

    @Override
    public IEmployee[] search(String name, String firstName) {
        
        return this.employeedData.search(name, firstName);
    }

    @Override
    public int size(Department department) {
        
        return this.employeedData.size(department);
    }

    @Override
    public IEmployee[] members(Department department) {
        
        return this.employeedData.member(department);
    }
